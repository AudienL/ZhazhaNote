...
public class FinishedNoteListActivity extends BaseActivity {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, FinishedNoteListActivity.class);
    ...
    public int getLayoutResId() {
        return R.layout.activity_finished_note_list;
    }
